...
// Create an audio context to share audio control across components
            ...
            <SlideContext.Provider value={slideContextValue}>
                ...
                >
                    ...
                    <main className={`flex-1 flex flex-col items-center justify-center ${isFullscreen ? 'p-0' : 'p-6'} overflow-hidden`}>
                        <div
                            className={`${isFullscreen ? '' : 'w-full max-w-7xl'} aspect-video bg-gray-800 rounded-lg overflow-hidden shadow-2xl relative`}
                            style={isFullscreen ? {
                                aspectRatio: '16/9',
